...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 13 15:35:19 2023
...
df_Utility_Disconnects = df_Utility_Disconnects[df_Utility_Disconnects['Year'] <= 2011]
...
df_rental_new = df_rental_new[df_rental_new['Permit Issue Year'] <= 2011]
...
# convert year to age
df_rental_new['Permit Issue Year'] = 2011-df_rental_new['Permit Issue Year']
...
df_SFIncidents_new = df_SFIncidents_new.loc[(df_SFIncidents_new['Year'] >=2011) &  (df_SFIncidents_new['Year'] <=2015)]
...
ready_anytime['ready_anytime'] = 0 # as 2011 or before doesn't have any inspection data, for those years 'ready_anytime'=0 for all addresses 
...
df_foreclosure_new = df_foreclosure_new[df_foreclosure_new['YEAR'] <= 2011]
