...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 20 21:43:09 2023
...
df_Utility_Disconnects = df_Utility_Disconnects[df_Utility_Disconnects['Year'] <= 2012]
...
df_rental_new = df_rental_new[df_rental_new['Permit Issue Year'] <= 2012]
...
# convert year to age
df_rental_new['Permit Issue Year'] = 2012-df_rental_new['Permit Issue Year']
...
df_SFIncidents_new = df_SFIncidents_new.loc[(df_SFIncidents_new['Year'] >=2012) &  (df_SFIncidents_new['Year'] <=2016)]
...
fire = df_SFIncidents_new.loc[(df_SFIncidents_new['Year'] <=2012)]
fire = fire.groupby(['Location'], sort=False)['Year'].max().reset_index()
fire['Year'] = 2012 - fire['Year']
...
df_foreclosure_new = df_foreclosure_new[df_foreclosure_new['YEAR'] <= 2012]
