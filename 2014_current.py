...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 20 21:55:11 2023
...
df_Utility_Disconnects = df_Utility_Disconnects[df_Utility_Disconnects['Year'] <= 2014]
...
df_rental_new = df_rental_new[df_rental_new['Permit Issue Year'] <= 2014]
...
# convert year to age
df_rental_new['Permit Issue Year'] = 2014-df_rental_new['Permit Issue Year']
...
df_SFIncidents_new = df_SFIncidents_new.loc[(df_SFIncidents_new['Year'] >=2014) &  (df_SFIncidents_new['Year'] <=2018)]
...
fire = df_SFIncidents_new.loc[(df_SFIncidents_new['Year'] <=2014)]
fire = fire.groupby(['Location'], sort=False)['Year'].max().reset_index()
fire['Year'] = 2014 - fire['Year']
...
df_foreclosure_new = df_foreclosure_new[df_foreclosure_new['YEAR'] <= 2014]
