...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 20 22:01:38 2023
...
df_Utility_Disconnects = df_Utility_Disconnects[df_Utility_Disconnects['Year'] <= 2015]
...
df_rental_new = df_rental_new[df_rental_new['Permit Issue Year'] <= 2015]
...
# convert year to age
df_rental_new['Permit Issue Year'] = 2015-df_rental_new['Permit Issue Year']
...
df_SFIncidents_new = df_SFIncidents_new.loc[(df_SFIncidents_new['Year'] >=2015) &  (df_SFIncidents_new['Year'] <=2019)]

df_fire = df_SFIncidents_new[df_SFIncidents_new['Code']==111]

df_fire = df_fire[['Location']]

# # filter by year for last incident before or on 2015

fire = df_SFIncidents_new.loc[(df_SFIncidents_new['Year'] <=2015)]
fire = fire.groupby(['Location'], sort=False)['Year'].max().reset_index()
fire['Year'] = 2015 - fire['Year']
...
# remove data after 2015
ready_anytime = ready_anytime[ready_anytime['Last Inspected']<=2015]
...
# remove data after 2015
df_foreclosure_new = df_foreclosure_new[df_foreclosure_new['YEAR'] <= 2015]
