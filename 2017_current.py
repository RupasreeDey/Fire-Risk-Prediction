...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 20 22:35:20 2023
...
df_offenses_new = df_offenses_new[df_offenses_new['Year'] <= 2017]
...
df_Utility_Disconnects = df_Utility_Disconnects[df_Utility_Disconnects['Year'] <= 2017]
...
df_rental_new = df_rental_new[df_rental_new['Permit Issue Year'] <= 2017]
...
# convert year to age
df_rental_new['Permit Issue Year'] = 2017-df_rental_new['Permit Issue Year']
...
df_SFIncidents_new = df_SFIncidents_new.loc[(df_SFIncidents_new['Year'] >=2017) &  (df_SFIncidents_new['Year'] <=2021)]
...
fire = df_SFIncidents_new.loc[(df_SFIncidents_new['Year'] <=2017)]
fire = fire.groupby(['Location'], sort=False)['Year'].max().reset_index()
fire['Year'] = 2017 - fire['Year']
...
# remove data after 2017
ready_anytime = ready_anytime[ready_anytime['Last Inspected']<=2017]
...
# remove data after 2017
df_foreclosure_new = df_foreclosure_new[df_foreclosure_new['YEAR'] <= 2017]
